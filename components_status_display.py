...
class StatusDisplay:
    ...
    def get_relationship_stage_info(self, affection: int) -> Dict[str, str]:
        ...
        return self.stage_colors.get(stage, self.stage_colors["ステージ3：中立"])
    ...
    def render_relationship_stage(self, affection: int) -> None:
        ...
        try:
            ...
            if affection < 20:
                ...
                st.write("🟠 **関係性**: ステージ2：警戒")
            elif affection < 60:
                st.write("🟡 **関係性**: ステージ3：中立")
            elif affection < 80:
                st.write("🟢 **関係性**: ステージ4：好意")
            else:
                st.write("💜 **関係性**: ステージ5：親密")
    ...
    def get_status_display_config(self) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                ...
                "stage_info": self.stage_colors["ステージ3：中立"],
                "history_count": 0,
                "statistics": {},
